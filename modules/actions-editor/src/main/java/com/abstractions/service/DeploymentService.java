...
public class DeploymentService {
  ...
  private boolean isCDNAware(ApplicationSnapshot applicationSnapshot) {
    return applicationSnapshot.getProperty(MessageUtils.APPLICATION_CLOUDFRONT_ACCESS) != null
            && applicationSnapshot.getProperty(MessageUtils.APPLICATION_CLOUDFRONT_SECRET) != null && !applicationSnapshot.getResources().isEmpty();
  }
  ...
  @Transactional
  public void addLazyComputedCache(long deploymentId, String contextId, String elementId, String memcachedURL, String ttl, String keyExpression,
  ...
  @Transactional
  public void addLazyAutorefreshableCache(long deploymentId, String contextId, String elementId, String memcachedURL, String oldCacheEntryInMills,
  ...
  @Transactional
  public void addLogger(long deploymentId, String contextId, String elementId, String beforeExpression, String afterExpression, Boolean isBeforeConditional,
          Boolean isAfterConditional, String beforeConditionalExpressionValue, String afterConditionalExpressionValue) {
