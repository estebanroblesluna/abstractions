...
public class UserService implements UserServiceIface {
  ...
  public User getUser(long userId) {
    return this.userRepository.get(User.class, userId);
  }
  ...
  private boolean emailExists(String email) {
    return (userRepository.findBy(User.class, "email", email) != null);
  }
  
  @Transactional
  private boolean usernameExists(String username) {
    return (userRepository.findBy(User.class, "username", username) != null);
  }
  ...
  public void registerUser(String username, String password, String email, String firstName, String lastName) throws UsernameExistsException, EmailExistsException,
    ...
    User newUser = new User(username, sha1password, email, firstName, lastName, new Date(), enabled, confirmed, auths);
