...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      <iframe src="/editor/index.html?saveUrl=/teams/${teamId}/applications/${applicationId}/flows/save/${flow.id}&contextId=${flow.name}" style="width:100%; height: 550px" frameBorder="0"></iframe>
      </div>
    </div>
  </div>
</body>
