 ...
 */
@implementation AddLazyAutorefreshableCacheDelegate : CPObject 
{
	@outlet CPWindow _window;

	@outlet id _memcachedURLTF;
	@outlet id _oldCacheEntryInMillsTF;
...
- (IBAction) add: (id) aSender
{
	...
	var oldCacheEntryInMills = [_oldCacheEntryInMillsTF stringValue];
	...
	[[[_window windowController] elementAPI]
		addLazyAutorefreshableCache: memcachedURL 
