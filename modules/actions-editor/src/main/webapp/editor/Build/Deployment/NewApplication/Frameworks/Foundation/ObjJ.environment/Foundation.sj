@STATIC;1.0;p;12;Foundation.jt;3493;@STATIC;1.0;i;13;_CGGeometry.ji;9;CPArray.ji;10;CPBundle.ji;16;CPCharacterSet.ji;9;CPCoder.ji;23;CPComparisonPredicate.ji;21;CPCompoundPredicate.ji;8;CPData.ji;8;CPDate.ji;14;CPDictionary.ji;14;CPEnumerator.ji;13;CPException.ji;13;CPFormatter.ji;12;CPIndexSet.ji;14;CPInvocation.ji;17;CPKeyedArchiver.ji;19;CPKeyedUnarchiver.ji;18;CPKeyValueCoding.ji;21;CPKeyValueObserving.ji;16;CPMutableArray.ji;14;CPMutableSet.ji;16;CPNotification.ji;22;CPNotificationCenter.ji;8;CPNull.ji;10;CPNumber.ji;10;CPObject.ji;15;CPObjJRuntime.ji;29;CPPropertyListSerialization.ji;9;CPRange.ji;11;CPRunLoop.ji;11;CPScanner.ji;7;CPSet.ji;18;CPSortDescriptor.ji;10;CPString.ji;9;CPTimer.ji;15;CPUndoManager.ji;7;CPURL.ji;17;CPURLConnection.ji;14;CPURLRequest.ji;15;CPURLResponse.ji;16;CPUserDefaults.ji;9;CPValue.ji;20;CPValueTransformer.jt;2669;objj_executeFile("_CGGeometry.j", YES);objj_executeFile("CPArray.j", YES);objj_executeFile("CPBundle.j", YES);/* objj_executeFile("CPByteCountFormatter.j", YES) */ (undefined);objj_executeFile("CPCharacterSet.j", YES);objj_executeFile("CPCoder.j", YES);objj_executeFile("CPComparisonPredicate.j", YES);objj_executeFile("CPCompoundPredicate.j", YES);objj_executeFile("CPData.j", YES);objj_executeFile("CPDate.j", YES);/* objj_executeFile("CPDateFormatter.j", YES) */ (undefined);/* objj_executeFile("CPDecimal.j", YES) */ (undefined);/* objj_executeFile("CPDecimalNumber.j", YES) */ (undefined);/* objj_executeFile("CPDelayedPerform.j", YES) */ (undefined);objj_executeFile("CPDictionary.j", YES);objj_executeFile("CPEnumerator.j", YES);/* objj_executeFile("CPError.j", YES) */ (undefined);objj_executeFile("CPException.j", YES);/* objj_executeFile("CPExpression.j", YES) */ (undefined);objj_executeFile("CPFormatter.j", YES);/* objj_executeFile("CPIndexPath.j", YES) */ (undefined);objj_executeFile("CPIndexSet.j", YES);objj_executeFile("CPInvocation.j", YES);/* objj_executeFile("CPJSONPConnection.j", YES) */ (undefined);objj_executeFile("CPKeyedArchiver.j", YES);objj_executeFile("CPKeyedUnarchiver.j", YES);objj_executeFile("CPKeyValueCoding.j", YES);objj_executeFile("CPKeyValueObserving.j", YES);/* objj_executeFile("CPLocale.j", YES) */ (undefined);objj_executeFile("CPMutableArray.j", YES);objj_executeFile("CPMutableSet.j", YES);objj_executeFile("CPNotification.j", YES);objj_executeFile("CPNotificationCenter.j", YES);objj_executeFile("CPNull.j", YES);objj_executeFile("CPNumber.j", YES);/* objj_executeFile("CPNumberFormatter.j", YES) */ (undefined);objj_executeFile("CPObject.j", YES);objj_executeFile("CPObjJRuntime.j", YES);/* objj_executeFile("CPOperation.j", YES) */ (undefined);/* objj_executeFile("CPOperationQueue.j", YES) */ (undefined);/* objj_executeFile("CPPredicate.j", YES) */ (undefined);objj_executeFile("CPPropertyListSerialization.j", YES);objj_executeFile("CPRange.j", YES);objj_executeFile("CPRunLoop.j", YES);objj_executeFile("CPScanner.j", YES);objj_executeFile("CPSet.j", YES);objj_executeFile("CPSortDescriptor.j", YES);objj_executeFile("CPString.j", YES);objj_executeFile("CPTimer.j", YES);/* objj_executeFile("CPTimeZone.j", YES) */ (undefined);objj_executeFile("CPUndoManager.j", YES);objj_executeFile("CPURL.j", YES);objj_executeFile("CPURLConnection.j", YES);objj_executeFile("CPURLRequest.j", YES);objj_executeFile("CPURLResponse.j", YES);objj_executeFile("CPUserDefaults.j", YES);/* objj_executeFile("CPUserSessionManager.j", YES) */ (undefined);objj_executeFile("CPValue.j", YES);objj_executeFile("CPValueTransformer.j", YES);p;10;CPObject.jt;11730;@STATIC;1.0;t;11710;{var the_class = objj_allocateClassPair(Nil, "CPObject"),
...
p;16;CPMutableArray.jt;14057;@STATIC;1.0;i;10;_CPArray.jt;14022;objj_executeFile("_CPArray.j", YES);{var the_class = objj_allocateClassPair(CPArray, "CPMutableArray"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
p;7;CPSet.jt;94;@STATIC;1.0;i;23;_CPConcreteMutableSet.jt;49;objj_executeFile("_CPConcreteMutableSet.j", YES);p;23;_CPConcreteMutableSet.jt;3564;@STATIC;1.0;i;14;CPMutableSet.jt;3526;objj_executeFile("CPMutableSet.j", YES);var hasOwnProperty = Object.prototype.hasOwnProperty;
...
objj_executeFile("CPArray+KVO.j", YES);objj_executeFile("CPSet+KVO.j", YES);p;13;CPArray+KVO.jt;21372;@STATIC;1.0;i;9;CPArray.ji;8;CPNull.ji;27;_CPCollectionKVCOperators.jt;21295;objj_executeFile("CPArray.j", YES);objj_executeFile("CPNull.j", YES);objj_executeFile("_CPCollectionKVCOperators.j", YES);{
var the_class = objj_getClass("CPObject")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"CPObject\"");
